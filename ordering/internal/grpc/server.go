...
import (
	...
	"github.com/fd1az/mallbots/ordering/internal/application/commands"
	"github.com/fd1az/mallbots/ordering/internal/application/queries"
...
func (s server) CreateOrder(
	ctx context.Context,
	request *orderingpb.CreateOrderRequest,
...
func (s server) CancelOrder(
	ctx context.Context,
	request *orderingpb.CancelOrderRequest,
...
func (s server) ReadyOrder(
	ctx context.Context,
	request *orderingpb.ReadyOrderRequest,
) (*orderingpb.ReadyOrderResponse, error) {
...
func (s server) CompleteOrder(
	ctx context.Context,
	request *orderingpb.CompleteOrderRequest,
...
func (s server) GetOrder(
	ctx context.Context,
	request *orderingpb.GetOrderRequest,
) (*orderingpb.GetOrderResponse, error) {

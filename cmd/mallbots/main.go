...
import (
	...
	"github.com/fd1az/mallbots/baskets"
	"github.com/fd1az/mallbots/customers"
	"github.com/fd1az/mallbots/depot"
	"github.com/fd1az/mallbots/internal/config"
	"github.com/fd1az/mallbots/internal/logger"
	"github.com/fd1az/mallbots/internal/monolith"
	"github.com/fd1az/mallbots/internal/rpc"
	"github.com/fd1az/mallbots/internal/waiter"
	"github.com/fd1az/mallbots/internal/web"
	"github.com/fd1az/mallbots/notifications"
	"github.com/fd1az/mallbots/ordering"
	"github.com/fd1az/mallbots/payments"
	"github.com/fd1az/mallbots/stores"
)

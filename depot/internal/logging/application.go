...
import (
	...
	"github.com/fd1az/mallbots/depot/internal/application/commands"
	"github.com/fd1az/mallbots/depot/internal/application/queries"
...
func (a Application) CreateShoppingList(
	ctx context.Context,
...
func (a Application) CancelShoppingList(
	ctx context.Context,
...
func (a Application) AssignShoppingList(
	ctx context.Context,
...
func (a Application) CompleteShoppingList(
	ctx context.Context,
...
func (a Application) GetShoppingList(
	ctx context.Context,
